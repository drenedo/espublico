...
public class OrderMother {
    ...
    public static Order any() {
        return new Order(UUID.randomUUID(), new OrderId(RANDOM.nextLong()), RegionMother.any(), CountryMother.any(), ItemTypeMother.any(),
                ...
                LocalDate.now(), LocalDate.now(), RANDOM.nextInt(), BigDecimal.valueOf(RANDOM.nextDouble()), BigDecimal.valueOf(RANDOM.nextDouble()),
                BigDecimal.valueOf(RANDOM.nextDouble()), BigDecimal.valueOf(RANDOM.nextDouble()), BigDecimal.valueOf(RANDOM.nextDouble()));
    }
}
